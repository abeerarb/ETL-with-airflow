...
class Globals:
    ...
    user_ids = ["5e57ed5a03ed52ad545fafb7"]
                # , "5edc9ce503ed5252d3361fa8", "6256d942674c9170c17c2e25",
    ...
    elk_ips ="http://192.168.1.119:8080" # ['https://dbelk1.afaqy.local:9200', 'https://dbelk2.afaqy.local:9200', 'https://dbelk3.afaqy.local:9200']
    elk_basic_auth = ('abeer.a','123@456')#("elastic", "d=m+jbB1xh0k*-ik5GQB")
    ...
    chunk_size = 1000
    index_name= "units_statistics"
    parent_username= "abeer.araby" 
    parent_password= "2vmdnnKo3" 
